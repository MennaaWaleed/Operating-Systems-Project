...
enum
{
	...
	SYS_sbrk,               // For 1st fn system call
		SYS_free_user_mem,       // For 2nd fn system call
		SYS_allocate_user_mem,// For 3rd fn system call
		SYS_get_perms,SYS_sesperiority,
		SYS_enqueue,
		SYS_init_queue,
		SYS_dequeue,SYS_sched,
	//=====================================================================
	NSYSCALLS
};
