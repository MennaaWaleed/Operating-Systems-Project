...
// must declare here el 3 vars of kh
uint32 kh_start; // kernel heap start
uint32 sgm_brk; // segment break of specific allocated space "sbrk"
uint32 rlmt; // max limit that can't be exceeded "hard limit"
