...
int test_kmalloc()
{
	...
	correct = 1 ;
	{
		...
		if ((freeFrames - (int)sys_calculate_free_frames()) < 512) { correct = 0; cprintf("1 Wrong allocation: pages are not loaded successfully into memory\t%d\n", (freeFrames - (int)sys_calculate_free_frames())); }
